...
export class CancelarReembolsoUseCase {
    constructor(
    ...
    async execute(id: number, solicitanteId: number) {
        ...
        if (reembolso.solicitanteId !== solicitanteId) throw new UnauthorizedError('Apenas o dono pode cancelar esta solicitação.');
