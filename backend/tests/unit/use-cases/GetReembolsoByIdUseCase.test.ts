...
const buildReembolso = (solicitanteId = 1) =>
    new SolicitacaoDeReembolso({
        ...
        valor: 150, dataDespesa: new Date(), status: ReembolsoStatus.RASCUNHO,
...
describe('GetReembolsoByIdUseCase', () => {
    ...
    it('GESTOR pode visualizar reembolso de qualquer solicitante', async () => {
    ...
    it('FINANCEIRO pode visualizar reembolso de qualquer solicitante', async () => {
        repos.reembolso.findById.mockResolvedValue(buildReembolso(1));
    ...
    it('ADMIN pode visualizar reembolso de qualquer solicitante', async () => {
        repos.reembolso.findById.mockResolvedValue(buildReembolso(1));
